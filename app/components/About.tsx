                    ...
                    <div className="flex flex-col items-center w-full h-full">
                      ...
                      <div className="grow flex flex-col w-full h-full">
                        <EducationCertification
                          id={1}
                          title={t(
                            "educations-certifications-first-item-title"
                          )}
                        ...
                        <EducationCertification
                          id={2}
                          title={t(
                            "educations-certifications-second-item-title"
                          )}
                        ...
                        <EducationCertification
                          id={3}
                          title={t(
                            "educations-certifications-third-item-title"
                          )}
                        ...
                        <EducationCertification
                          id={4}
                          title={t(
                            "educations-certifications-fourth-item-title"
                          )}

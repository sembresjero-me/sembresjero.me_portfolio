      ...
      <div className="bg-card p-12 rounded-lg border border-secondary shadow-custom shadow-primary w-full my-32">
        ...
        <div className="mb-8">
          ...
          <div>
            ...
            <ul className="list-disc list-inside indent-4 mt-2">
        ...
        <div className="mb-8">
          ...
          <div className="mb-4">
            ...
            <p className="whitespace-pre-line">
              {t("privacy-policy-personal-data-description")}
            </p>
            <ul className="list-disc list-inside indent-4 mt-2">
          ...
          <div>
            ...
            <p className="whitespace-pre-line">
              {t("privacy-policy-usage-data-description")}
            </p>
          </div>
        </div>
        <div className="mb-8">
          ...
          <p className="whitespace-pre-line">
            {t("privacy-policy-cookies-first-description")}
          </p>
          ...
          <p className="whitespace-pre-line">
            {t("privacy-policy-cookies-second-description")}
          </p>
          <ul className="list-disc list-inside indent-4 my-2">
            <li className="mb-4">
              <h4 className="inline mb-4">
                {t("privacy-policy-cookies-necessary-essentials-title")}
              </h4>
              <p className="indent-12 my-2">
            ...
            <li className="mb-4">
              <h4 className="inline mb-4">
                {t("privacy-policy-cookies-acceptance-title")}
              </h4>
              <p className="indent-12 my-2">
                {t("privacy-policy-cookies-acceptance-type")}
              </p>
              <p className="indent-12 mb-2">
                {t("privacy-policy-cookies-acceptance-administrator")}
              </p>
              <p className="indent-12">
                {t("privacy-policy-cookies-acceptance-purpose")}
              </p>
            </li>
            <li>
              <h4 className="inline mb-4">
                {t("privacy-policy-cookies-functionality-title")}
              </h4>
              <p className="indent-12 my-2">
                {t("privacy-policy-cookies-functionality-type")}
              </p>
              <p className="indent-12 mb-2">
                {t("privacy-policy-cookies-functionality-administrator")}
              </p>
              <p className="indent-12">
                {t("privacy-policy-cookies-functionality-purpose")}
              </p>
            </li>
          </ul>
          <p className="whitespace-pre-line">
            {t("privacy-policy-cookies-third-description")}
          </p>
        </div>
        <div className="mb-8">
          <h3 className="w-full text-xl 2xl:text-2xl mb-2">
            {t("privacy-policy-use-of-your-data-title")}
          </h3>
          <p className="whitespace-pre-line">
          ...
          <ul className="list-disc list-inside indent-4 my-2">
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-first-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-second-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-third-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-fourth-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-fifth-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-sixth-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-seventh-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-first-description-eight-bullet-point"
              )}
            </li>
          </ul>
          <p className="whitespace-pre-line">
          ...
          <ul className="list-disc list-inside indent-4 mt-4">
            <li>
              {t(
                "privacy-policy-use-of-your-data-second-description-first-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-second-description-second-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-second-description-third-bullet-point"
              )}
            </li>
            <li>
              {t(
                "privacy-policy-use-of-your-data-second-description-fourth-bullet-point"
              )}
            </li>
            <li>
              {t(
            ...
            <li>
              {t(
                "privacy-policy-use-of-your-data-second-description-sixth-bullet-point"
              )}
            </li>
          </ul>
        </div>
        ...
        <div className="mb-8">
          <h3 className="w-full text-xl 2xl:text-2xl mb-2">
            {t("privacy-policy-delete-your-data-title")}
          </h3>
          <p className="whitespace-pre-line mb-2">
        ...
        <div className="mb-8">
          ...
          <div className="mb-4">
            <h4>
              {t(
                "privacy-policy-disclosure-of-your-data-business-transactions-title"
              )}
            </h4>
            <p>
              {t(
                "privacy-policy-disclosure-of-your-data-business-transactions-description"
              )}
            </p>
          </div>
          <div className="mb-4">
            <h4>
              {t(
                "privacy-policy-disclosure-of-your-data-law-enforcement-title"
              )}
            </h4>
            <p>
              {t(
                "privacy-policy-disclosure-of-your-data-law-enforcement-description"
              )}
            </p>
          </div>
          <h4>
            {t(
              "privacy-policy-disclosure-of-your-data-other-legal-requirements-title"
            )}
          </h4>
          <p>
            {t(
              "privacy-policy-disclosure-of-your-data-other-legal-requirements-description"
            )}
          </p>
          <ul className="list-disc list-inside indent-4 mt-4">
            <li>
        ...
        <div className="mb-8">
          <h3 className="w-full text-xl 2xl:text-2xl mb-2">
            {t("privacy-policy-childrens-privacy-title")}
          </h3>
          <p className="whitespace-pre-line mb-2">
        ...
        <div className="mb-8">
          ...
          <p className="whitespace-pre-line">
            {t("privacy-policy-contact-us-description")}
          </p>
          <ul className="list-disc list-inside indent-4 my-2">

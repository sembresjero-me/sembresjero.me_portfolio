  ...
  return (
    <>
      <div className="flex grow flex-col">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-8 md:grid-cols-3 xl:mb-16">
          ...
          <div className="w-full">
            <h4 className="text-xl">{t('skills-web-development-back-end-title')}</h4>
            <WebDevelopmentSkill
        ...
        <div className="grid grid-cols-3 gap-8">
          <div className="col-span-3 md:col-span-2">
            <h3 className="mb-4 text-2xl underline underline-offset-4">
              {t('skills-others-title')}
            </h3>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-8">
              <div className="w-full">
                <h4 className="text-xl">{t('skills-others-marketing-title')}</h4>
              ...
              <div className="w-full">
                <h4 className="text-xl">{t('skills-others-project-management-title')}</h4>
          ...
          <div className="col-span-3 md:col-span-1">
            <h3 className="mb-4 text-2xl underline underline-offset-4">{t('skills-soft-title')}</h3>

...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-lg font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        text: "text-accent relative no-underline opacity-70 hover:opacity-100 hover:after:scale-x-100 after:opacity-70 hover:after:opacity-100 after:scale-x-0 after:content-[''] after:absolute after:w-full after:h-0.5 after:bottom-0 after:left-0 after:bg-accent after:origin-bottom-left after:transition-transform after:duration-500 after:ease-out",
